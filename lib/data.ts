...
export const obelia = {
  name: "Obelia",
  tagline: "This Urban Algae Project Redifines Built Environment",
  ...
  features: [
    ...
    { title: "Mental Wellbeing", description: "Living walls and algae installations" },
  ],
  stats: [
    { value: "40%", label: "CO2 Reduction" },
    { value: "24/7", label: "Active Purification" },
    { value: "Zero", label: "Chemical Usage" },
    { value: "1 liter", label: " 17 Indoor plants " },
    { value: "100 liter", label: " 1 mature tree " },
  ],
};
